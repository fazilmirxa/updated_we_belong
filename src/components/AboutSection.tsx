...
import { guitarImg } from '../assets'; // removed guitarBG
    ...
    <>
      <section className="mt-20 py-16 px-6 md:px-20 flex flex-col md:flex-row items-center justify-between relative overflow-hidden">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0">
          ...
          <p className="text-[#1a1a1a] text-base leading-relaxed mb-4 w-[320px] md:w-[540px]">
          ...
          <p className="text-[#1a1a1a] text-base leading-relaxed w-[320px] md:w-[540px]">
        ...
        {/* Right - Just Guitar Image */}
        <div className="flex justify-center">
          <div className="w-[320px] md:w-[600px] rounded-2xl overflow-hidden">
            <img
              src={guitarImg}
              alt="Guitar"
